...
class PluginRTCPeerConnectionConstraints {
	...
	init(pcConstraints: NSDictionary?) {
		PluginUtils.debug("PluginRTCPeerConnectionConstraints#init()")
		...
		PluginUtils.debug("PluginRTCPeerConnectionConstraints#init() | [mandatoryConstraints:%@, optionalConstraints:%@]",
	...
	deinit {
		PluginUtils.debug("PluginRTCPeerConnectionConstraints#deinit()")
	}

	func getConstraints() -> RTCMediaConstraints {
		PluginUtils.debug("PluginRTCPeerConnectionConstraints#getConstraints()")
